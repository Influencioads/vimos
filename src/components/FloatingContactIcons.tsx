...
const FloatingContactIcons = () => {
    return (
        <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-4">
            ...
            >
                <span className="absolute right-full mr-4 whitespace-nowrap rounded bg-black/80 px-2 py-1 text-sm font-medium text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100 pointer-events-none">
                    WhatsApp Us
                </span>
